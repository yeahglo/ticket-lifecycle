...
**_End-users have their own interface. Anonymous users can create tickets because it was set up this way in the [Post-Install Configuration](https://github.com/yeahglo/post-install-config)_** 
...
**_The Help Topics were also configured during the [Post-Install Configuration](https://github.com/yeahglo/post-install-config), are listed here._**
